$(document).ready(function(){
					...
					//alert($(".solutionMainSteps").width()+"  "+$(".Graph_main_div").width()+" "+$(".Btn_td1").width()*2)	
						
					width  = ($(".container-fluid").width()-($(".Graph_main_div").width()*2+($(".Btn_td1").width()*2)))/2;
