...
/*/////////////////////////////////////// Code on KeyPress ////////////////////////////////////////////////*/
	...
	inputKeyRestrict = function(e) {
			//alert("e.which == "+e.which)		
			  ...
			  var restrict = (e.which == 8 || e.which == 9 || e.which == 44 || e.which == 189 ||e.which == 39 ||e.which == 46 ||e.which == 45 || e.which == undefined || e.which == 0 || e.which == 109 || e.which == 40 || e.which == 41 ) ? null : String.fromCharCode(e.which).match(/[^0-9]/);
								 ...
								 if(x==44 && maxLength >= rClick){
								  ...
								  /////////////////////////////////////////////////////
								   ...
								   if(x==40&& maxLength >= rClick){
									...
									var secondValue = document.querySelector("#brace1");
									var bt1 = secondValue.getAttribute("data-value"); 
 									var prev = $txt.val();
								  ...
								  /////////////////////////////////////////////////////
								   ...
								   if(x==41 && maxLength >= rClick){
									...
									var secondValue = document.querySelector("#brace2");
									var bt1 = secondValue.getAttribute("data-value"); 
 									var prev = $txt.val();
